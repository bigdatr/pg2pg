...
var runCommands = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(commands, connections, config, notifications) {
        var i, c, fn;
    ...
    return function runCommands(_x2, _x3, _x4, _x5) {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 5:
                        ...
                        _context.next = 9;
                        return runCommands(config.commands, connections, config, notifications);
