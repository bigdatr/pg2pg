...
var PostgresConnector = function (_BaseConnector) {
    ...
    (0, _createClass3.default)(PostgresConnector, [{
                        ...
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                return _context3.abrupt('return', new _promise2.default(function (resolve, reject) {
                                    ...
                                    _cli2.default.debug(sql.query);
                                    _cli2.default.debug(sql.params);
        ...
        value: function toSQL(query) {
            ...
            var paramsArray = (0, _keys2.default)(params).map(function (p) {
                return params[p];
            });
            var paramsMap = (0, _keys2.default)(params).map(function (p, i) {
