...
var _batchAndProcess = function () {
    var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(batchSize, rows, onResults) {
    ...
    return function _batchAndProcess(_x9, _x10, _x11) {
...
var PostgresConnector = function (_BaseConnector) {
    ...
    (0, _createClass3.default)(PostgresConnector, [{
        ...
        key: 'query',
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(_query, params) {
                var _this4 = this;
                        ...
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                return _context3.abrupt('return', new _promise2.default(function (resolve, reject) {
                                    var sql = _this4.toSQL(_query, params);

                                    _cli2.default.debug('\n                QUERY:\n                    ' + sql.query + '\n\n                PARAMS:\n                    ' + (0, _stringify2.default)(sql.params) + '\n            ');

                                    _this4._client.query(sql.query, sql.params, function (err, result) {
                                        if (err) {
                                            _cli2.default.fatal(err.stack);
                                            return reject(err);
                                        }
        ...
        key: 'toSQL',
        value: function toSQL(query) {
            var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

            var usedParams = (0, _keys2.default)(params).filter(function (p) {
                return query.indexOf('${' + p + '}') !== -1;
            }).reduce(function (state, val) {
                return (0, _assign2.default)(state, (0, _defineProperty3.default)({}, val, params[val]));
            }, {});

            var paramsArray = (0, _keys2.default)(usedParams).map(function (p) {
                return usedParams[p];
            });
            var paramsMap = (0, _keys2.default)(usedParams).map(function (p, i) {
                return (0, _defineProperty3.default)({}, p, i + 1);
            }).reduce(function (state, val) {
            ...
            (0, _keys2.default)(usedParams).forEach(function (p) {
                var index = paramsMap[p];
                        ...
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                return _context5.abrupt('return', new _promise2.default(function (resolve, reject) {
                                    ...
                                    var sql = _this5.toSQL(query, params);
                                    var cursor = _this5._client.query(new _pgCursor2.default(sql.query, sql.params));
                                    ...
                                    function _readFromCursor() {
                                        ...
                                        cursor.read(batchSize, function () {
                                            var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(err, rows) {
        ...
        key: 'bulkInsert',
        value: function () {
            var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(table, rows) {
                var _this7 = this;
