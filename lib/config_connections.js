        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _cli2.default.debug('Connecting to all services');
...
var _RedshiftConnector = require('./connectors/RedshiftConnector');

var _RedshiftConnector2 = _interopRequireDefault(_RedshiftConnector);

var _HipChatConnector = require('./connectors/HipChatConnector');

var _HipChatConnector2 = _interopRequireDefault(_HipChatConnector);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var CONNECTORS = {
    postgres: _PostgresConnector2.default,
    redshift: _RedshiftConnector2.default,
    hipchat: _HipChatConnector2.default
};